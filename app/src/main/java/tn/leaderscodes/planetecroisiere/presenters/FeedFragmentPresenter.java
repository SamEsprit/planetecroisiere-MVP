...
public class FeedFragmentPresenter implements FeedFragmentContract.Presenter {

    private FeedFragmentContract.View view;
    ...
    public void do_showFeedsList() {
        mCompositeDisposable.add(publicationService.list(Session.getInstance().getToken())
